    ...
    try {
      ...
      const res = await fetch("/api/people/create", {
        ...
        body: JSON.stringify({
          ...
          ministryId: newPerson.ministryId || null,
          photoUrl: photoPreview,
          address,
          addressCep: newPerson.cep,
          addressStreet: newPerson.street,
          addressNumber: newPerson.number,
          addressComplement: newPerson.complement,
          addressNeighborhood: newPerson.neighborhood,
